...
namespace rl::gui {
    ...
    public:
         ...
         */
        RenderPass(const std::vector<Object*>& color_targets, Object* depth_target = nullptr,
                   Object* stencil_target = nullptr, Object* blit_target = nullptr,
                   bool clear = true);
        ...
        const Color& clear_color(size_t index) const
        {
            return m_clear_color.at(index);
        }
         ...
         */
        void blit_to(const Vector2i& src_offset, const Vector2i& src_size, Object* dst,
