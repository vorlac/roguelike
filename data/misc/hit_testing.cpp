...
const static SDL_Rect drag_areas[] = { { 20, 20, 100, 100 },
                                       { 200, 70, 100, 100 },
                                       { 400, 90, 100, 100 } };
const static SDL_FRect render_areas[] = { { 20.0f, 20.0f, 100.0f, 100.0f },
                                          { 200.0f, 70.0f, 100.0f, 100.0f },
                                          { 400.0f, 90.0f, 100.0f, 100.0f } };

const static SDL_Rect* areas = drag_areas;
...
int main(int argc, char** argv)
{
    ...
    while (!done)
    {
        ...
        for (i = 0; i < state->num_windows; ++i)
        {
            ...
            SDLTest_DrawString(state->renderers[i], (float)state->window_w / 2 - 80.0f, 10.0f,
                               "Drag the red boxes");
