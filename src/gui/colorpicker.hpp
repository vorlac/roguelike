...
namespace rl::gui {
    ...
    public:
         ...
         * before the user clicks \ref ColorPicker::mPickButton or
         * \ref ColorPicker::mPickButton.
         */
         ...
         * **and** the user clicks the \ref ColorPicker::m_pick_button or
         * \ref ColorPicker::m_reset_button.
         */
        const std::function<void(const Color&)>& final_callback() const
        {
         ...
         * \ref ColorPicker::m_reset_button.
         */
        void set_final_callback(const std::function<void(const Color&)>& callback)
        {
        ...
        /// The current caption of the \ref ColorPicker::m_pick_button.
        const std::string& pick_button_caption()
        {
            return m_pick_button->caption();
        }

        /// Sets the current caption of the \ref ColorPicker::m_pick_button.
        void set_pick_button_caption(const std::string& caption)
        {
            m_pick_button->set_caption(caption);
        }

        /// The current caption of the \ref ColorPicker::m_reset_button.
        const std::string& reset_button_caption()
        {
            return m_reset_button->caption();
        }

        /// Sets the current caption of the \ref ColorPicker::m_reset_button.
        void set_reset_button_caption(const std::string& caption)
        {
            m_reset_button->set_caption(caption);
        }
    ...
    protected:
         ...
         * \ref ColorPicker::set_pick_button_caption if you need.
         *
         * The color of this Button will not affect \ref ColorPicker::color
         * until the user has actively selected by clicking this pick button.
         * Similarly, the \ref ColorPicker::m_callback function is only
         ...
         * \ref ColorPicker::m_pick_button.  The default value for the
         * caption of this Button is ``"Reset"``.  You can change it using
         * \ref ColorPicker::set_reset_button_caption if you need.
         */
