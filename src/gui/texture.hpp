...
namespace rl::gui {
    ...
    public:
         ...
         */
        Texture(PixelFormat pixel_format, ComponentFormat component_format, const Vector2i& size,
                ...
                uint8_t flags = (uint8_t)TextureFlags::ShaderRead, bool mipmap_manual = false);
        ...
        InterpolationMode min_interpolation_mode() const
        {
            return m_min_interpolation_mode;
        }

        /// Return the interpolation mode for minimization
        InterpolationMode mag_interpolation_mode() const
        {
            return m_mag_interpolation_mode;
        }
        ...
        /// Upload packed pixel data to a rectangular sub-region of the texture from the CPU to the
        /// GPU
        ...
        uint32_t renderbuffer_handle() const
        {
