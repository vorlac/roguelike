...
SDL_C_LIB_END
  ...
  #pragma warning(disable : 4201)  // warning C4244: conversion from X to Y, possible loss of data
#endif
...
namespace rl::gui {
    ...
    public:
        ...
        Color(const Color& c)
            : Color(c._d.r, c._d.g, c._d.b, c._d.a)
        {
        }
        ...
        explicit Color(float intensity, float alpha)
        {
            _d.r = _d.g = _d.b = intensity;
            _d.a = alpha;
        }

        explicit Color(int intensity, int alpha)
        {
        ...
        {
            constexpr static float e = std::numeric_limits<float>::epsilon();
            return std::abs(c.a() - a()) > e || std::abs(c.r() - r()) > e ||
                   std::abs(c.g() - g()) > e || std::abs(c.b() - b()) > e;
        }

        Color contrastingColor() const
        {
            float luminance = r() * 0.299f + g() * 0.587f + b() * 0.144f;
            return Color(luminance < 0.5f ? 1.0f : 0.0f, 1.0f);
        }
    ...
    public:
        ...
        /**
         * @brief Checks if this vector equals the o one.
        ...
        /**
         * @brief Get the dot product of this vector with ano.
        ...
        /**
         * @brief Gets distance from ano point.
        ...
        /**
         * @brief Returns squared distance from ano point.
         * Here, the vector is interpreted as a point in 2-dimensional space.
         * @param o o vector to measure from.
        ...
        /**
         * @brief rotates the point anticlockwise around a center by an amount of degrees.
        ...
        /**
         * @brief Calculates the angle of this vector in degrees in the trigonometric sense.
        ...
        /**
         * @brief Calculates the angle of this vector in degrees in the counter trigonometric sense.
        ...
        /**
         * @brief Calculates the angle between this vector and ano one in degree.
        ...
        /**
         * @brief Returns if this vector interpreted as a point is on a line between two o points.
        ...
        /**
         * @brief Creates an interpolated vector between this vector and ano vector.
        ...
        /**
         * @brief Creates a quadratically interpolated vector between this and two o vectors.
         * @param v2 Second vector to interpolate with.
         * @param v3 Third vector to interpolate with (maximum at 1.0f)
         * @param d Interpolation value between 0.0f (all this vector) and 1.0f (all the 3rd
         * vector).
         * @note this is the opposite direction of interpolation to getInterpolated() and
         * interpolate() \return An interpolated vector. This vector is not modified.
         **/
        Vector2<T> getInterpolated_quadratic(const Vector2<T>& v2, const Vector2<T>& v3,
                                             const T d) const
        {
        ...
        /**
         * @brief Sets this vector to the linearly interpolated vector between a and b.
        ...
        inline Vector2<float> tofloat() const
        {
            return cast<float>();
        }

        inline Vector2<int> toint() const
        {
            return cast<int>();
        }

        inline Vector2<float> floor() const
        {
            return Vector2<float>(std::floor(x), std::floor(y));
        }

        inline Vector2<float> ceil() const
        {
