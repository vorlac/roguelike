...
namespace rl::gui {
    ...
    protected:
        ...
        float cursor_index_to_position(int index, float lastx, const NVGglyphPosition* glyphs,
                                       int size);
        int position_to_cursor_index(float posx, float lastx, const NVGglyphPosition* glyphs,
                                     int size);
