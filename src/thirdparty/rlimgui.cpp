...
//
//         if (width > 0 && height > 0)
//             io.DisplayFramebufferScale = ImVec2(width / io.DisplaySize.x, height /
//             io.DisplaySize.y);
//         else
...
//         internal::MouseCursorMap[ImGuiMouseCursor_Hand]       =
//         raylib::MOUSE_CURSOR_POINTING_HAND; internal::MouseCursorMap[ImGuiMouseCursor_ResizeAll]
//         = raylib::MOUSE_CURSOR_RESIZE_ALL; internal::MouseCursorMap[ImGuiMouseCursor_ResizeEW] =
//         raylib::MOUSE_CURSOR_RESIZE_EW; internal::MouseCursorMap[ImGuiMouseCursor_ResizeNESW] =
//         raylib::MOUSE_CURSOR_RESIZE_NESW; internal::MouseCursorMap[ImGuiMouseCursor_ResizeNS]   =
//         raylib::MOUSE_CURSOR_RESIZE_NS; internal::MouseCursorMap[ImGuiMouseCursor_ResizeNWSE] =
//         raylib::MOUSE_CURSOR_RESIZE_NWSE; internal::MouseCursorMap[ImGuiMouseCursor_NotAllowed] =
...
//                                         draw_data->DisplayPos.x), cmd.ClipRect.w -
//                                         (cmd.ClipRect.y - draw_data->DisplayPos.y));
//
