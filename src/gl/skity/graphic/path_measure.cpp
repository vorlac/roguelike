...
namespace skity {
    ...
    PathMeasure::PathMeasure(const Path& path, bool forceClosed, float resScale)
    ...
    bool PathMeasure::getSegment(float startD, float stopD, Path* dst, bool startWithMoveTo)
    {
        return contour_ && contour_->getSegment(startD, stopD, dst, startWithMoveTo);
    }

    bool PathMeasure::isClosed()
    {
