...
namespace skity {
    ...
    void Canvas::drawSimpleText(const char* text, float x, float y, const Paint& paint)
    {
        this->drawSimpleText2(text, x, y, paint);
    }

    void Canvas::drawSimpleText2(const char* text, float x, float y, const Paint& paint)
    {
    ...
    void Canvas::drawTextBlob(const TextBlob* blob, float x, float y, const Paint& paint)
    {
    ...
    void Canvas::internalSave()
    {
        this->onSave();
    }

    void Canvas::internalRestore()
    {
        this->onRestore();
    }

    void Canvas::onDrawLine(float x0, float y0, float x1, float y1, const Paint& paint)
    {
        Path path;
        path.moveTo(x0, y0);
        path.lineTo(x1, y1);
    ...
    void Canvas::onDrawCircle(float cx, float cy, float radius, const Paint& paint)
    {
        if (radius < 0)
            radius = 0;
    ...
    void Canvas::onDrawOval(const Rect& oval, const Paint& paint)
    {
        RRect rrect;
        rrect.setOval(oval);
    ...
    void Canvas::onDrawRRect(const RRect& rrect, const Paint& paint)
    {
        Path path;
        path.addRRect(rrect);
        path.setConvexityType(Path::ConvexityType::kConvex);
    ...
    void Canvas::onDrawRect(const Rect& rect, const Paint& paint)
    {
        Path path;
        path.addRect(rect);
    ...
    void Canvas::onDrawRoundRect(const Rect& rect, float rx, float ry, const Paint& paint)
    {
        if (rx > 0 && ry > 0)
        {
            RRect rrect;
    ...
    bool Canvas::needGlyphPath(const Paint& paint)
    {
