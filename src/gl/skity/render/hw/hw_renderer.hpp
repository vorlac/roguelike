...
namespace skity {
    ...
    public:
         ...
         * @param mvp
         */
        virtual void SetViewProjectionMatrix(const glm::mat4& mvp)
        {
            mvp_matrix_ = mvp;
        }
         ...
         *
         */
        virtual void SetUniformColor(const glm::vec4& color) = 0;
         ...
         * @param info
         */
        virtual void SetGradientBoundInfo(const glm::vec4& info) = 0;
         ...
         * @param colors
         */
        virtual void SetGradientColors(const std::vector<Color4f>& colors) = 0;
         ...
         * @param pos
         */
        virtual void SetGradientPositions(const std::vector<float>& pos) = 0;
