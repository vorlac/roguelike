...
namespace skity {
    ...
    void GLFontTexture::Destroy()
    {
        GLTexture::Destroy();
    }

    HWTexture* GLFontTexture::GetHWTexture()
    {
        return this;
    }

    void GLFontTexture::OnUploadRegion(uint32_t x, uint32_t y, uint32_t width, uint32_t height,
                                       uint8_t* data)
    {
        this->Bind();
