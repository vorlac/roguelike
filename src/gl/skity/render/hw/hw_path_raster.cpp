...
namespace skity {
    ...
    void HWPathRaster::OnEndPath()
    {
        ...
        HandleLineCap(first_pt_, first_pt_ + first_normal * stroke_radius,
                      first_pt_ - first_normal * stroke_radius, -first_pt_dir_, stroke_radius);
        ...
        HandleLineCap(curr_pt_, curr_pt_ + prev_normal * stroke_radius,
                      curr_pt_ - prev_normal * stroke_radius, prev_dir, stroke_radius);
    }

    void HWPathRaster::OnMoveTo(const glm::vec2& p)
    {
        first_pt_ = p;
        if (stroke_)
            return;
    ...
    void HWPathRaster::OnLineTo(const glm::vec2& p1, const glm::vec2& p2)
    {
        if (stroke_)
            StrokeLineTo(p1, p2);
        else
    ...
    void HWPathRaster::OnQuadTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3)
    {
        if (stroke_)
        {
    ...
    void HWPathRaster::StrokeLineTo(const glm::vec2& p1, const glm::vec2& p2)
    {
        if (p1 == first_pt_)
        {
            // first point
    ...
    void HWPathRaster::StrokeQuadTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3)
    {
        if (p1 == first_pt_)
        {
            // first point
    ...
    void HWPathRaster::GSStrokeQuadTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3)
    {
        if (p1 == first_pt_)
        {
            // first point
    ...
    void HWPathRaster::FillLineTo(const glm::vec2& p1, const glm::vec2& p2)
    {
        if (p1 == first_pt_)
            return;
    ...
    void HWPathRaster::FillQuadTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3)
    {
        if (!UseGeometryShader())
            return;
    ...
    void HWPathRaster::HandleLineJoin(const glm::vec2& p1, const glm::vec2& p2, float stroke_radius)
    {
        ...
        if (orientation == Orientation::kLinear)
        {
            ...
            if (FloatIsNan(curr_join.x) || FloatIsNan(curr_join.y))
                return;
            HandleBevelJoinInternal(p1, prev_join, curr_join, glm::normalize(prev_dir - curr_dir));
            return;
        }
    ...
    void HWPathRaster::HandleMiterJoinInternal(const Vec2& center, const Vec2& p1, const Vec2& d1,
    ...
    void HWPathRaster::HandleBevelJoinInternal(const Vec2& center, const Vec2& p1, const Vec2& p2,
                                               const Vec2& curr_dir)
    {
    ...
    void HWPathRaster::HandleRoundJoinInternal(const Vec2& center, const Vec2& p1, const Vec2& d1,
                                               const Vec2& p2, const Vec2& d2)
    {
        if (UseGeometryShader())
    ...
    void HWPathRaster::HandleRoundJoinWithGS(const Vec2& center, const Vec2& p1, const Vec2& d1,
                                             const Vec2& p2, const Vec2& d2)
    {
        Vec2 out_point = center + glm::normalize(d1 - d2) * StrokeWidth() * FloatRoot2Over2;
    ...
    void HWPathRaster::GSFillQuad(Orientation orientation, const glm::vec2& p1, const glm::vec2& p2,
                                  const glm::vec2& p3)
    {
