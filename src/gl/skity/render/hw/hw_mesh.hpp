...
namespace skity {
    ...
    public:
        ...
        size_t AppendVertex(float x, float y, float mix, float u = 0.f, float v = 0.f);
        size_t AppendVertex(const HWVertex& vertex);
        ...
        size_t AppendIndices(const std::vector<uint32_t>& indices);
