...
#define QUAD_BEVEL_LIMIT 0.01f
    ...
    void HWPathVisitor::VisitPath(const Path& path, bool force_close)
    {
    ...
    void HWPathVisitor::HandleQuadTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3)
    {
    ...
    void HWPathVisitor::HandleConicTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3,
                                      float weight)
    {
    ...
    void HWPathVisitor::HandleCubicTo(const glm::vec2& p1, const glm::vec2& p2, const glm::vec2& p3,
                                      const glm::vec2& p4)
    {
        ...
        for (;;)
        {
            ...
            if (std::max(delta1.x, delta1.y) > 0.5f || std::max(delta2.x, delta2.y) > 0.5f)
                goto SPLIT;
