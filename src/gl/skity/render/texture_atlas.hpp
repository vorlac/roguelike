...
namespace skity {
    ...
    public:
         ...
         */
        void UploadRegion(uint32_t x, uint32_t y, uint32_t width, uint32_t height, uint8_t* data);
    ...
    protected:
        virtual void OnUploadRegion(uint32_t x, uint32_t y, uint32_t width, uint32_t height,
                                    uint8_t* data)
        {
        }
