...
namespace skity {
    ...
    public:
         ...
         * @return std::shared_ptr<Data>
         */
        static std::shared_ptr<Data> MakeWithProc(const void* ptr, size_t length, ReleaseProc proc,
                                                  void* ctx);
    ...
    private:
        static std::shared_ptr<Data> PrivateNewWithCopy(const void* srcOrNull, size_t length);
