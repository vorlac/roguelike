...
#define BND_DISABLED_ALPHA 0.5
    ...
    using BNDwidgetTheme = BNDwidgetTheme;
    using BNDnodeTheme = BNDnodeTheme;
    using BNDtheme = BNDtheme;
    using BNDtextAlignment = BNDtextAlignment;
    using BNDwidgetState = BNDwidgetState;
    using BNDcornerFlags = BNDcornerFlags;
    using BNDicon = BNDicon;
    ...
    void bndLabel(NVGcontext* ctx, float x, float y, float w, float h, int iconid,
                  const char* label);
