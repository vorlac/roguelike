    ...
    public:
        ...
        struct Event
        {
            ...
            enum ID : std::underlying_type_t<SDL3::SDL_EventType>
            {
                ...
                // The first MainWindow::Event::ID possible (lowest integer value)
                Shown = SDL3::SDL_EVENT_WINDOW_SHOWN,
                // MainWindow has been shown
                Hidden = SDL3::SDL_EVENT_WINDOW_HIDDEN,
                // MainWindow has been hidden
                Exposed = SDL3::SDL_EVENT_WINDOW_EXPOSED,
                // MainWindow has been exposed and should be redrawn
                ...
                // MainWindow has gained focus of the pressure-sensitive pen with ID "data1"
                PenLeave = SDL3::SDL_EVENT_WINDOW_PEN_LEAVE,
                // MainWindow has lost focus of the pressure-sensitive pen with ID "data1"
                WindowLast = SDL3::SDL_EVENT_WINDOW_LAST,
                // The last MainWindow::Event::ID possible (highest integer value)
            };
        };
        ...
        struct DisplayEvent
        {
            ...
            enum ID : std::underlying_type_t<SDL3::SDL_EventType>
            {
                ...
                // The first MainWindow::DisplayEvent::ID possible (lowest integer value)
                ...
                // The last MainWindow::DisplayEvent::ID possible (highest integer value)
            };
        };
