...
namespace rl::ui::icon {
    ...
    struct FA4
    {
        constexpr static inline std::string_view FileName{ "fontawesome-webfont.ttf" };

        constexpr static inline u16 IconMin{ 0xf000 };
        constexpr static inline u16 IconMax16{ 0xf2e0 };
        constexpr static inline u16 IconMax{ 0xf2e0 };
        ...
        constexpr static inline std::string_view BellO{ "\xef\x82\xa2" };                             // U+f0a2
