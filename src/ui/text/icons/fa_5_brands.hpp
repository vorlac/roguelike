...
namespace rl::ui::icon {
    ...
    struct FA5Brands
    {
        constexpr static inline std::string_view FileName{ "fa-brands-400.ttf" };
        ...
        constexpr static inline std::string_view AcquisitionsIncorporated{ "\xef\x9a\xaf" };     // U+f6af
        ...
        constexpr static inline std::string_view DribbbleSquare{ "\xef\x8e\x97" };               // U+f397
        ...
        constexpr static inline std::string_view FontAwesomeAlt{ "\xef\x8d\x9c" };               // U+f35c
        constexpr static inline std::string_view FontAwesomeFlag{ "\xef\x90\xa5" };              // U+f425
        ...
        constexpr static inline std::string_view HackerNewsSquare{ "\xef\x8e\xaf" };             // U+f3af
        ...
        constexpr static inline std::string_view Innosoft{ "\xee\x82\x80" };                     // U+e080
        constexpr static inline std::string_view Instagram{ "\xef\x85\xad" };                    // U+f16d
        constexpr static inline std::string_view InstagramSquare{ "\xee\x81\x95" };              // U+e055
        ...
        constexpr static inline std::string_view JsSquare{ "\xef\x8e\xb9" };                     // U+f3b9
        ...
        constexpr static inline std::string_view MediumM{ "\xef\x8f\x87" };                      // U+f3c7
        ...
        constexpr static inline std::string_view PennyArcade{ "\xef\x9c\x84" };                  // U+f704
        ...
        constexpr static inline std::string_view PiedPiperSquare{ "\xee\x80\x9e" };              // U+e01e
        ...
        constexpr static inline std::string_view SlackHash{ "\xef\x8f\xaf" };                    // U+f3ef
        ...
        constexpr static inline std::string_view TelegramPlane{ "\xef\x8f\xbe" };                // U+f3fe
        ...
        constexpr static inline std::string_view WhatsappSquare{ "\xef\x90\x8c" };               // U+f40c
        ...
        constexpr static inline std::string_view YoutubeSquare{ "\xef\x90\xb1" };                // U+f431
