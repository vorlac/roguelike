...
namespace rl::ui::icon {
    ...
    struct MaterialDesign {
        ...
        constexpr static inline u16 IconMax16{ static_cast<u16>(0xf8ff) };
        constexpr static inline u16 IconMax{ static_cast<u16>(0x10fffd) };
        ...
        constexpr static inline std::string_view Goat{ "\xf4\x8f\xbf\xbd" };                                  // U+10fffd
