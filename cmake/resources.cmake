...
foreach(bin ${fonts_list})
  ...
  file(APPEND ${fonts_cpp} "uint8_t ${filename}[] = {${filedata}0x00};\n")
...
foreach(bin ${roguelike_shader_resources})
  ...
  file(READ ${bin} filedata HEX)
  string(REGEX REPLACE "([0-9a-f][0-9a-f])" "0x\\1," filedata ${filedata})
  file(APPEND ${shaders_hpp} "const uint8_t ${filename}[] = {${filedata}};\n\n")
  file(APPEND ${shaders_hpp} "const uint32_t ${filename}_size = sizeof(${filename});\n\n")
endforeach()
